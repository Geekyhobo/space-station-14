...
public sealed class DamageOnAttackedSystem : EntitySystem
{
    ...
    private void OnAttacked(Entity<DamageOnAttackedComponent> entity, ref AttackedEvent args)
    {
        ...
        {
            _adminLogger.AddStructured(LogType.Damaged, $"{args.User:user} injured themselves by attacking {entity:target} and received {totalDamage.GetTotal():damage} damage");
