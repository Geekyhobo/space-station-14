...
public abstract class SharedGasThermoMachineSystem : EntitySystem
{
    ...
    private void OnToggleMessage(EntityUid uid, GasThermoMachineComponent thermoMachine, GasThermomachineToggleMessage args)
    {
        ...
        _adminLogger.AddStructured(LogType.AtmosPowerChanged, $"{args.Actor} turned {(powerState ? "On" : "Off")} {uid}");
    ...
    private void OnChangeTemperature(EntityUid uid, GasThermoMachineComponent thermoMachine, GasThermomachineChangeTemperatureMessage args)
    {
        ...
        _adminLogger.AddStructured(LogType.AtmosTemperatureChanged, $"{args.Actor} set temperature on {uid} to {thermoMachine.TargetTemperature}");
