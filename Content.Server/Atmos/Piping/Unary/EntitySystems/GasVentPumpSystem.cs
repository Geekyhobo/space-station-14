            ...
            switch (cmd)
            {
                ...
                case DeviceNetworkConstants.CmdSetState:
                    ...
                    if (previous.PressureChecks != setData.PressureChecks)
                        _adminLogger.AddStructured(LogType.AtmosDeviceSetting, LogImpact.Medium, $"{uid} pressure check changed to {setData.PressureChecks}");
                    ...
                    if (previous.PressureLockoutOverride != setData.PressureLockoutOverride)
                    {
                        ...
                        _adminLogger.AddStructured(LogType.AtmosDeviceSetting, LogImpact.Medium, $"{uid} pressure lockout override {enabled}");
                    }
